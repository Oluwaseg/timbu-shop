    ...
    <div className="bg-[#FBF4F5] w-full h-full flex flex-col gap-6 md:pb-16 pb-10">
      <div className="bg-primary md:bg-secondary">
        ...
        <div className="md:hidden mt-1 border-b-2 border-black">
          <nav className="p-3">
            <ul className="flex justify-center text-accent-500 overflow-x-auto whitespace-nowrap responsive-nav">
      ...
      <div className="flex max-md:flex-col max-md:gap-3 justify-between w-full md:px-16 mx-auto">
        ...
        <p className="font-medium max-md:ml-5 max-md:text-base">
          ...
          <span className="text-[#DE8C99] ml-2">Please Login</span>
        </p>
      ...
      <div className="md:px-16 px-5 w-full flex flex-col items-center gap-6 ">
        <div className="text-accent-500 rounded-lg md:py-4 md:px-2 py-5 px-3 max-md:text-sm w-full">
          <div className=" bg-[#ffffff] px-4 py-4 rounded-lg">
            <h1 className="bg-[#fdf0f1] uppercase font-medium w-full px-2 py-3 border-b-2 border-gray-400">
              <span>1. customer details</span>
            </h1>
            <div className="px-2 py-2">
              <p className="text-gray-700 font-medium">Badru Islamiyat</p>
              <span className="text-gray-600 mt-4">
                House 28, Umbrella Bus Stop, Odogunyan, Ikorodu | Osun- Ile Ife
                | 08158879092
              </span>
            </div>
          </div>
          <div className=" bg-[#ffffff] px-4 py-4 rounded-lg mt-4">
            <h1 className="bg-[#fdf0f1] uppercase font-medium w-full px-2 py-3 border-b-2 border-gray-400">
              <span>2. Delivery Details</span>
            </h1>
            <div className="px-2 py-2">
              <p className="text-gray-700 font-medium">Rider Pick Up</p>
              <span className="text-gray-600 mt-4">
                Between 15 July and 27 July
              </span>
            </div>
          </div>
          <div className=" bg-[#ffffff] px-4 py-4 rounded-lg mt-4">
            ...
            <div className="px-2 py-2">
              ...
              <span className="text-gray-600 mt-4">
                You will be redirected to secured payment page
              </span>
            </div>
          </div>
        </div>
        ...
        <NavLink
          to="/payment"
          className="bg-[#FFB6C1] font-bold text-center border-2 border-[#DE8C99] w-full md:w-1/2 md:py-3 md:px-5 py-2 px-3 rounded-full"
        >
          Place Order
        </NavLink>
      </div>
